...
public interface IMonedaRepository extends JpaRepository<Moneda, String>{
	String queryAll = "select new com.bancoexterior.tesoreria.ve.dto.MonedaDto(t.codMoneda, t.descripcion, t.codAlterno, t.flagActivo, t.codUsuario, t.fechaModificacion) "
			+ " from Moneda t"
			+ " where 1=1";
