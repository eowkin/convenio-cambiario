...
@Data
public class TasaRequestConsulta implements Serializable{
	...
	@Valid
	private TasaDtoRequestConsulta tasaDtoRequestConsulta; 
	
	public TasaRequestConsulta() {
		super();
		tasaDtoRequestConsulta = new TasaDtoRequestConsulta();
	}
