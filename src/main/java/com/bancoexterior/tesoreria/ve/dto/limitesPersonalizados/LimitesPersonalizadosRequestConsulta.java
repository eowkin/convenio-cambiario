...
@Data
public class LimitesPersonalizadosRequestConsulta implements Serializable{
	...
	@JsonProperty("limitesPersonalizados")
	...
	public LimitesPersonalizadosRequestConsulta() {
		super();
		limitesPersonalizadosDtoRequestConsulta = new LimitesPersonalizadosDtoRequestConsulta();
	}
	/**
	 * 
	 */
